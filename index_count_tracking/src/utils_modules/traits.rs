...
pub trait FromJsonNumeric: Sized {
    fn from_u64(u: u64) -> Option<Self> { let _ = u; None }
    fn from_i64(i: i64) -> Option<Self> { let _ = i; None }
    fn from_f64(f: f64) -> Option<Self> { let _ = f; None }
}
...
impl FromJsonNumeric for f64 {
    fn from_u64(u: u64) -> Option<Self> { Some(u as f64) }
    fn from_i64(i: i64) -> Option<Self> { Some(i as f64) }
    fn from_f64(f: f64) -> Option<Self> { f.is_finite().then_some(f) }
}

impl FromJsonNumeric for f32 {
    fn from_u64(u: u64) -> Option<Self> { Some(u as f32) }
    fn from_i64(i: i64) -> Option<Self> { Some(i as f32) }
    fn from_f64(f: f64) -> Option<Self> { f.is_finite().then_some(f as f32) }
}